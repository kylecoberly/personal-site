...
},{"./fp/_baseConvert":4,"./lodash.min":7}],4:[function(require,module,exports){
...
},{"./_mapping":5,"./placeholder":6}],5:[function(require,module,exports){
...
var $talkItems = fp_1.flow([
    processTalks,
    fp_1.map(createTalkItem),
])(talks_1.talks);
fp_1.forEach(function (talk) { return $talks.appendChild(talk); })($talkItems);
...
function processTalks(talks) {
    return fp_1.flow([
        fp_1.orderBy(["date"], ["desc"]),
        fp_1.map(processTalk),
    ])(talks);
}
...
},{"./talks":10,"dayjs":1,"dayjs/plugin/advancedFormat":2,"lodash/fp":3,"showdown":8}],10:[function(require,module,exports){
